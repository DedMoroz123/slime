...
gdjs.evtsExt__Flash__ToggleColorTint.conditionTrue_0 = {val:false};
gdjs.evtsExt__Flash__ToggleColorTint.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__Flash__ToggleColorTint.condition1IsTrue_0 = {val:false};
gdjs.evtsExt__Flash__ToggleColorTint.condition2IsTrue_0 = {val:false};


gdjs.evtsExt__Flash__ToggleColorTint.eventsList0 = function(runtimeScene, eventsFunctionContext) {

};gdjs.evtsExt__Flash__ToggleColorTint.mapOfGDgdjs_46evtsExt_95_95Flash_95_95ToggleColorTint_46GDObjectObjects2Objects = Hashtable.newFrom({"Object": gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects2});
gdjs.evtsExt__Flash__ToggleColorTint.mapOfGDgdjs_46evtsExt_95_95Flash_95_95ToggleColorTint_46GDObjectObjects1Objects = Hashtable.newFrom({"Object": gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1});
...
gdjs.evtsExt__Flash__ToggleColorTint.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__Flash__ToggleColorTint.condition0IsTrue_0.val = gdjs.evtsExt__Flash__ColorTint.func(runtimeScene, gdjs.evtsExt__Flash__ToggleColorTint.mapOfGDgdjs_46evtsExt_95_95Flash_95_95ToggleColorTint_46GDObjectObjects2Objects, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) == (gdjs.RuntimeObject.getVariableString(((gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects2.length === 0 ) ? gdjs.VariablesContainer.badVariablesContainer : gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects2[0].getVariables()).get("__FlashColor_StartingTint")));
}if (gdjs.evtsExt__Flash__ToggleColorTint.condition0IsTrue_0.val) {
...
for(var i = 0, k = 0, l = gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1[i].getVariableBoolean(gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1[i].getVariables().get("__Flash_ColorTintToggled"), false) ) {
        gdjs.evtsExt__Flash__ToggleColorTint.condition0IsTrue_0.val = true;
        gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1[k] = gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1[i];
        ++k;
    }
}
gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1.length = k;}if ( gdjs.evtsExt__Flash__ToggleColorTint.condition0IsTrue_0.val ) {
{
gdjs.evtsExt__Flash__ToggleColorTint.condition1IsTrue_0.val = !(gdjs.evtsExt__Flash__ColorTint.func(runtimeScene, gdjs.evtsExt__Flash__ToggleColorTint.mapOfGDgdjs_46evtsExt_95_95Flash_95_95ToggleColorTint_46GDObjectObjects1Objects, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) == (gdjs.RuntimeObject.getVariableString(((gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1.length === 0 ) ? gdjs.VariablesContainer.badVariablesContainer : gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1[0].getVariables()).get("__FlashColor_StartingTint"))));
}}
if (gdjs.evtsExt__Flash__ToggleColorTint.condition1IsTrue_0.val) {
