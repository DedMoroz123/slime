...
gdjs.evtsExt__Flash__ToggleEffect.conditionTrue_0 = {val:false};
gdjs.evtsExt__Flash__ToggleEffect.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__Flash__ToggleEffect.condition1IsTrue_0 = {val:false};
gdjs.evtsExt__Flash__ToggleEffect.condition2IsTrue_0 = {val:false};
...
for(var i = 0, k = 0, l = gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[i].isEffectEnabled((typeof eventsFunctionContext !== 'undefined' ? "" + eventsFunctionContext.getArgument("EffectName") : "")) ) {
        gdjs.evtsExt__Flash__ToggleEffect.condition0IsTrue_0.val = true;
        gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[k] = gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[i];
        ++k;
    }
}
gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1.length = k;}if (gdjs.evtsExt__Flash__ToggleEffect.condition0IsTrue_0.val) {
...
for(var i = 0, k = 0, l = gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1.length;i<l;++i) {
    if ( !(gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[i].isEffectEnabled((typeof eventsFunctionContext !== 'undefined' ? "" + eventsFunctionContext.getArgument("EffectName") : ""))) ) {
        gdjs.evtsExt__Flash__ToggleEffect.condition1IsTrue_0.val = true;
        gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[k] = gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[i];
        ++k;
    }
}
gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1.length = k;}}
if (gdjs.evtsExt__Flash__ToggleEffect.condition1IsTrue_0.val) {
/* Reuse gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1 */
{for(var i = 0, len = gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1.length ;i < len;++i) {
